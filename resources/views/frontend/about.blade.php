...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" integrity="sha384-h5dHlWfCTzmeSmG1rN8tAiRD2PJ+J3aTeAX2Jzq6tvUVjW4U7XJ5GB3xMzlf51A" crossorigin="anonymous">
...
<body data-bs-spy="scroll" data-bs-target="#navbarExample">
    ...
    <div class="ex-basic-1 pt-5 pb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-fluid mt-5 mb-3" src="images/img/image026.jpg" style="width: 100%; " alt="alternative">
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    </div>
    ...
    <div class="ex-basic-1 pt-4">
        <div class="container">
            <div class="row">
                <h2 class="mb-3" style="padding-left: 30px;">{{__('messages.lucky-charm')}}</h2>

                <div class="col-xl-10 offset-xl-1">
                    <p>{{__('messages.lucky-charm-p1')}}
                        </p>
                    <p class="">{{__('messages.lucky-charm-p2')}}</p>
                    <p class="">{{__('messages.lucky-charm-p3')}}
                        </p>
                        <p class="">{{__('messages.lucky-charm-p4')}}
                        </p>
